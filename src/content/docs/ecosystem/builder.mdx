...
From there, keep prompting. _"Add a title screen."_ _"Make the enemies faster."_ _"Add a high score table."_ You can extend with custom GDScript and your own nodes. The game is yours.
